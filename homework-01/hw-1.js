...
// //* - Присвоюю нову ціну товару  - 2000
// price = 2000;
// console.log(` Обрано ${name}, ціна за штуку ${price} кредитів`);
...
// const total = 100;
// const ordered = 50;
// const totalPrice = total < ordered ? `"На складі недостатньо товарів!"` : `"Замовлення оформлено, з вами зв'яжеться менеджер"`;
...
//    switch (country) { 
//      case "China" : 
//         message ='Доставка в China буде коштувати 100 кредитів';
//         break;
  
//      case "Chile": 
//         message = 'Доставка в Chile буде коштувати 250 кредитів' ; 
//         break;
  
//       case "Australia": 
//         message = 'Доставка в Australia буде коштувати 170 кредитів' ; 
//         break;

//         case "India": 
//         message = 'Доставка в India буде коштувати 170 кредитів' ; 
//         break;
  
//        case "Jamaica": 
//         message = 'Доставка в Jamaica буде коштувати 120 кредитів' ; 
//         break;
...
//     return message;
//   }
//   console.log(getShippingCost("Chilee"));
